...
Επίσης η ασκηση έχει υλοποιηθει με εναν πινακα (ετσι καταλαβα απο εκφωνηση), δεν καταλαβα
αν μπορω να εχω δυο πινακες δηλαδη εναν για τα αντικειμενα μηχανες
και εναν για τα αμαξια...
*/
#include <iostream>
#include <typeinfo>
#define N 10
...
int main()
{
    ...
    /* Δεν κατάλαβα αν θελατε για κάθε αντηκείμενο τον αριθμό (αυτό εκανα πιο πάνω με την print() (ξεχωριστά για Car και ξεχωριστα για Bike)),
    οποτε έκανα overloading εδω τον '+' για να φέρω το συνολικό αριθμό απο αντικείμενα στο Garage */
